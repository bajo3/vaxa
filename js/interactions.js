  ...
  (function clientSelector() {
    ...
    var DATA = [
      { key: "Hogar", label: "Hogar", icon: "i-home", title: "Servicios para tu hogar",
        ...
        serv: ["Control de plagas", "Control de cucarachas", "Control de roedores", "Control de mosquitos", "Limpieza de tanques", "Análisis de agua potable"],
        cliente: "un hogar" },
      ...
      { key: "Empresa", label: "Empresa", icon: "i-building", title: "Servicios para empresas",
        ...
        serv: ["Control de plagas urbano", "Control de roedores", "Control de cucarachas", "Limpieza de tanques", "Análisis de agua potable", "Mantenimiento preventivo"],
        cliente: "una empresa" },
      { key: "Consorcio", label: "Consorcio", icon: "i-building", title: "Servicios para consorcios y administraciones",
        text: "Control de plagas, limpieza de tanques, reparación, impermeabilización y análisis de agua potable para edificios y espacios comunes.",
        serv: ["Control de plagas en edificios", "Control de cucarachas", "Control de roedores", "Limpieza de tanques", "Reparación e impermeabilización", "Análisis de agua potable", "Mantenimiento sanitario preventivo"],
      ...
      { key: "Administración", label: "Administración", icon: "i-folder", title: "Servicios para administraciones",
        ...
        serv: ["Control de plagas en edificios", "Control de plagas", "Limpieza de tanques", "Reparación e impermeabilización", "Análisis de agua potable", "Mantenimiento sanitario preventivo"],
      ...
      { key: "Escuela", label: "Escuela", icon: "i-school", title: "Servicios para escuelas e instituciones",
        ...
        serv: ["Control de plagas", "Control de cucarachas", "Control de roedores", "Limpieza de tanques", "Análisis bacteriológico de agua", "Mantenimiento preventivo"],
